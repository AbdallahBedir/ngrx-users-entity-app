...
export const usersLoaded = createAction('[User/API] Users Loaded Success', props<{ users: User[] }>());
export const addUser = createAction('[User/API] Add User', props<{ user: any }>());
...
export const setSelectedUserId = createAction('[User/API] Set Selected User Id', props<{ id: string }>());